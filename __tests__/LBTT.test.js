...
const LBTTrecursive = require("../LBTTrecursive");
...
describe("LBTT", () => {
  ...
  it("returns correct result if passed the a value in the fourth tax paying band", () => {
    const value = 2000000;
    const result = LBTT(value);
    expect(result).toBe(198350);
  });
  it("returns correct result if passed a very large value in the fourth tax paying band", () => {
    const value = 50000000;
    const result = LBTT(value);
    expect(result).toBe(5958350);
  });
});

describe("LBTTrecursive", () => {
  it("returns zero if passed zero", () => {
    const value = 0;
    const result = LBTTrecursive(value);
    expect(result).toBe(0);
  });
  it("returns zero if passed a value of < 145000", () => {
    const value = 20000;
